...
A capacidade de analisar dados, identificar padrões e comunicar insights de maneira clara são aspectos que continuo aprimorando para enriquecer essa nova jornada. Na transição de carreira, estou empolgada em explorar e contribuir para o mundo da Data Science, combinando minha experiência anterior com as habilidades técnicas necessárias para impulsionar a inovação e a tomada de decisões baseadas em dados. </ul>
